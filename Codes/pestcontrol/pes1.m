...
tp=t0+Infor.Topt(end)+Infor2.Topt(end)+Infora.Topt(end)+Infora1.Topt(end)+Infor3.Topt(end)+Infor4.Topt(end)+Infor5.Topt(end)+Infora3.Topt(end)+Infor6.Topt(end)+Infor7.Topt(end)+Infor8.Topt(end)+Infor9.Topt(end)+Infor10.Topt(end)+Infor11.Topt(end)+Infor12.Topt(end);

C13=TopSearch(C12,P);
C13=[C13(1) C13(2)-2];
X13=[C13(1) C13(2) 0 0 0 0];
Infor13=nonlimpc(X12',X13,10);
Xplo=[Xplo;Infor13.Xopt(:,1)];
Yplo=[Yplo;Infor13.Xopt(:,2)];
lst=getpathcells(C13,C12,lst,Ng);
P=Pestcontrol(xig,yig,Ng,tp+Infor13.Topt(end),lst);
map = occupancyMap(P);
figure()
show(map)
hold on;
...
Infor14=nonlimpc(X13',X14,10);
Xplo=[Xplo;Infor14.Xopt(:,1)];
Yplo=[Yplo;Infor14.Xopt(:,2)];
lst=getpathcells(C14,C13,lst,Ng);
P=Pestcontrol(xig,yig,Ng,tp+Infor13.Topt(end)+Infor14.Topt(end),lst);
map = occupancyMap(P);
figure()
show(map)
hold on;
...
C15=BottomSearch(C14,P);
C15=[C15(1) C15(2)+2];
X15=[C15(1) C15(2) pi 0 0 0];
Infor15=nonlimpc(X14',X15,10);
Xplo=[Xplo;Infor15.Xopt(:,1)];
Yplo=[Yplo;Infor15.Xopt(:,2)];
lst=getpathcells(C15,C14,lst,Ng);
P=Pestcontrol(xig,yig,Ng,tp+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end),lst);
map = occupancyMap(P);
figure()
show(map)
hold on;
...
P=Pestcontrol(xig,yig,Ng,tp+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end)+Infor16.Topt(end),lst);
map = occupancyMap(P);
figure()
show(map)
hold on;
...
CL3 = C15;
CL4 = C16;
tpl=tp+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end)+Infor16.Topt(end);
...
for i=1:3
    ...
    C13=CL1;
    X13=[C13(1) C13(2) 0 0 0 0];
    Infor13=nonlimpc(X16',X13,10);
    Xplo=[Xplo;Infor13.Xopt(:,1)];
Yplo=[Yplo;Infor13.Xopt(:,2)];
    lst=getpathcells(C13,C16,lst,Ng);
    P=Pestcontrol(xig,yig,Ng,tpl+Infor13.Topt(end),lst);
    map = occupancyMap(P);
    figure()
    show(map)
    hold on;
...
Yplo=[Yplo;Infor14.Xopt(:,2)];
    lst=getpathcells(C14,C13,lst,Ng);
    P=Pestcontrol(xig,yig,Ng,tpl+Infor13.Topt(end)+Infor14.Topt(end),lst);
    map = occupancyMap(P);
    figure()
    show(map)
    hold on;
...
Yplo=[Yplo;Infor15.Xopt(:,2)];
    lst=getpathcells(C15,C14,lst,Ng);
    P=Pestcontrol(xig,yig,Ng,tpl+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end),lst);
    map = occupancyMap(P);
    figure()
    show(map)
    hold on;
...
Yplo=[Yplo;Infor16.Xopt(:,2)];
    lst=getpathcells(C16,C15,lst,Ng);
    P=Pestcontrol(xig,yig,Ng,tpl+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end)+Infor16.Topt(end),lst);
    map = occupancyMap(P);
    figure()
    show(map)
    hold on;
    ...
    tpl=tpl+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end)+Infor16.Topt(end);
end
hold off;
...
% Infor17=nonlimpc(X16',X17,10);
% lst=getpathcells(C17,C16,lst,Ng);
% P=Pestcontrol(xig,yig,Ng,tp+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end)+Infor16.Topt(end)+Infor17.Topt(end),lst);
% map = occupancyMap(P);
% figure()
% show(map)
% hold on;
...
%
% C18=RightSearch(C17,P);
% C18=[C18(1)-2 C18(2)];
% X18=[C18(1) C18(2) 0 0 0 0];
% Infor18=nonlimpc(X17',X18,10);
% lst=getpathcells(C18,C17,lst,Ng);
% P=Pestcontrol(xig,yig,Ng,tp+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end)+Infor16.Topt(end)+Infor17.Topt(end)+Infor18.Topt(end),lst);
% map = occupancyMap(P);
% figure()
% show(map)
% hold on;
...
%
% C19=BottomSearch(C18,P);
% C19=[C19(1) C19(2)+1];
% X19=[C19(1) C19(2) pi 0 0 0];
% Infor19=nonlimpc(X18',X19,10);
% lst=getpathcells(C19,C18,lst,Ng);
% P=Pestcontrol(xig,yig,Ng,tp+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end)+Infor16.Topt(end)+Infor17.Topt(end)+Infor18.Topt(end)+Infor19.Topt(end),lst);
% map = occupancyMap(P);
% figure()
% show(map)
% hold on;
...
%
% C20=LeftSearch(C19,P);
% C20=[C20(1)-1 C20(2)];
% X20=[C20(1) C20(2) pi 0 0 0];
% Infor20=nonlimpc(X19',X20,10);
% lst=getpathcells(C20,C19,lst,Ng);
% P=Pestcontrol(xig,yig,Ng,tp+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end)+Infor16.Topt(end)+Infor17.Topt(end)+Infor18.Topt(end)+Infor19.Topt(end)+Infor20.Topt(end),lst);
% map = occupancyMap(P);
% figure()
% show(map)
% hold on;
...
% C12=C16;
% tp=tp+Infor13.Topt(end)+Infor14.Topt(end)+Infor15.Topt(end)+Infor16.Topt(end);
