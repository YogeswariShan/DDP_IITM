...
Infor2=nonlimpcmultitr(X1',X2,20);
s=size(Ttot,1);
...
Infor3=nonlimpcmultitr(X20',X3,20);
s=size(Ttot,1);
...
Infora1=nonlimpcmultitr(X3',X30,10);
s=size(Ttot,1);
...
Infor4=nonlimpcmultitr(X30',X4,15);
s=size(Ttot,1);
...
Infor5=nonlimpcmultitr(X40',X5,10);
s=size(Ttot,1);
...
Infor6=nonlimpcmultitr(X50',X6,10);
s=size(Ttot,1);
